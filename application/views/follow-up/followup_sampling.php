		      	...
		      	<div class="card-body">
		      		<div class="row">
						...
						<div class="col-md-12">
							...
							<hr>
							<div>
								<a <?php if(($row->LSAM_DELDATE==null) || ($row->FLWS_ID==4) || ($row->FLWS_ID==5) || (!$this->access_m->isAdd('Follow Up', 1)->row()) && ($this->session->GRP_SESSION !=3)){echo "hidden";}?> href="#" data-toggle="modal" data-target="#add-followup" class="btn btn-success btn-sm"><i class="fa fa-user-plus"></i> Add</a>
							</div><br>
