							...
							<form action="<?php echo site_url('cs/edit_sampling_process/'.$row->CLOG_ID)?>" method="POST" enctype="multipart/form-data">
								<div class="row">
									...
									<div class="col-md-3">
										...
										<div class="form-group">
											<label>Note</label>
											<textarea class="form-control" cols="100%" rows="5" name="LSAM_NOTES"><?php echo str_replace("<br>", "\r\n", $row->LSAM_NOTES) ?></textarea>
										</div>
									</div>
									<div class="col-md-3">
										<div class="form-group">
									...
									<div class="col-md-3">
										...
										<div align="center">
											<?php if((!$this->access_m->isEdit('Product Sampling CS', 1)->row()) && ($this->session->GRP_SESSION !=3)) : ?>
												<a href="<?php echo site_url('cs/sampling') ?>" class="btn btn-sm btn-warning" name="batal"><i class="fa fa-arrow-left"></i> Back</a>
											<?php else: ?>
