...
<div class="container-fluid">
	...
	<ol class="breadcrumb">
		<li class="breadcrumb-item">
	  	...
	  	<li class="breadcrumb-item">
	    	<a href="<?php echo site_url('followup/assign_followup/'.$row->CLOG_ID) ?>">Assign</a>
	  	</li>
		...
		<div class="col-md-12">
		    <div class="card mb-3">
		    	<div class="card-header">
		      	...
		      	<div class="card-body">
		      		<form action="<?php echo site_url('cs/edit_followup_assign/'.$row->FLWP_ID)?>" method="POST" enctype="multipart/form-data">
			      		<div class="row">
							<div class="col-md-12">
								<div class="row">
