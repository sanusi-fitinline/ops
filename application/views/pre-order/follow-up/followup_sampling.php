		      	...
		      	<div class="card-body">
		      		<div class="row">
						<div class="col-md-12">
							<div class="row">
								...
								<div class="col-md-3">
									...
									<div class="form-group">
										<label>Courier</label>
										<input class="form-control" type="text" name="COURIER_NAME" value="<?php echo $row->COURIER_NAME ?>" readonly>
									</div>
									...
									<div class="form-group">
										<label>Bank</label>
										<input class="form-control" type="text" name="BANK_NAME" value="<?php echo $row->BANK_NAME ?>" readonly>
									</div>
									<div class="form-group">
										...
										<div class="input-group">
											...
											<input class="form-control" type="text" name="LSAM_PAYDATE" value="<?php echo $row->LSAM_PAYDATE!=null ? date('d-m-Y', strtotime($row->LSAM_PAYDATE)) : "" ?>" autocomplete="off" readonly>
									    </div>
									</div>
								</div>
								<div class="col-md-3">
									...
									<div class="form-group">
										...
										<input class="form-control" type="text" name="LSAM_RCPNO" value="<?php echo $row->LSAM_RCPNO ?>" readonly>
									</div>
								</div>
							</div>
						</div>
						<div class="col-md-12">
							...
							<hr>
							<div>
								<a <?php if(($row->LSAM_DELDATE==null) || ($row->FLWS_ID==4) || ($row->FLWS_ID==5) || (!$this->access_m->isAdd('Follow Up', 1)->row()) && ($this->session->GRP_SESSION !=3)){echo "hidden";}?> href="#" data-toggle="modal" data-target="#add-followup" class="btn btn-sm btn-success"><i class="fas fa-plus-circle"></i> Add</a>
							</div><br>
...
<div class="modal fade" id="add-followup">
	<div class="modal-dialog">
    	<div class="modal-content">
			...
			<form action="<?php echo site_url('cs/add_followup')?>" method="POST" enctype="multipart/form-data">
		    <!-- Modal body -->
