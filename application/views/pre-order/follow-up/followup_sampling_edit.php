...
<div class="container-fluid">
	...
	<ol class="breadcrumb">
		<li class="breadcrumb-item">
	  	...
	  	<li class="breadcrumb-item">
	    	<a href="<?php echo site_url('followup/sampling_followup/'.$row->CLOG_ID) ?>">Sampling</a>
	  	</li>
		...
		<div class="col-md-12">
		    <div class="card mb-3">
		    	<div class="card-header">
		      	...
		      	<div class="card-body">
		      		<form action="<?php echo site_url('cs/edit_followup/'.$row->FLWP_ID)?>" method="POST" enctype="multipart/form-data">
			      		<div class="row">
							<div class="col-md-12">
								<div class="row">
									...
									<div class="col-md-3">
										...
										<div align="center">
						                	...
						                	<?php else: ?>
						                		...
						                		<a class="btn btn-sm btn-danger" href="<?php echo site_url('followup/sampling_followup/'.$row->CLOG_ID) ?>"><i class="fa fa-times"></i>&nbsp;&nbsp;Cancel</a>
							      			<?php endif ?>
								      	</div>
									</div>
								</div>
