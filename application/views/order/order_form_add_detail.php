								...
								<div class="row">
									<div class="col-md-3">
										...
										<div class="form-group" id="option" style="display: none;">
											<label>Option</label>
											<input class="form-control" type="text" name="ORDD_OPTION" list="LIST_OPTION" autocomplete="off">
									...
									<div class="col-md-3">
										<div class="form-group">
											...
											<input class="form-control" type="number" name="ORDD_QUANTITY" id="ORDD_QUANTITY" min="1" value="1" required>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="input-group">
												<input class="form-control" type="text" name="ORDV_WEIGHT" id="ORDV_WEIGHT" value="0"  readonly>
										...
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input class="form-control uang" type="text" name="ORDD_PRICE" id="ORDD_PRICE" value="0"  readonly>
												<input class="form-control uang" type="hidden" name="ORDD_PRICE_VENDOR" id="ORDD_PRICE_VENDOR" value="0"  readonly>
											</div>
										</div>
									</div>
								</div>
