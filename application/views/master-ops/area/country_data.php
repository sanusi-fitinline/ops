	 	...
	 	<div class="col-md-6 offset-md-3">
		    ...
		    <div class="card mb-3">
		    	<div class="card-header">
		      	...
		      	<div class="card-body">
		      		<div>
						<a <?php if((!$this->access_m->isAdd('Area', 1)->row()) && ($this->session->GRP_SESSION !=3)){echo "hidden";}?> href="<?php echo site_url('master/addcountry')?>" class="btn btn-sm btn-success"><i class="fas fa-plus-circle"></i> Add</a>
					</div><br>
