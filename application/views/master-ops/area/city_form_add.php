      	...
      	<div class="card-body">
      		<div class="row">
				<div class="col-md-12 offset-md-4">
					<h3>Input City</h3>
					<form action="<?php echo site_url('master/addcityprocess')?>" method="POST" enctype="multipart/form-data">
						<div class="row">
							<div class="col-md-3">
								...
								<div class="form-group">
									<label>City</label>
									<input class="form-control" type="text" name="CITY_NAME" autocomplete="off" required>
								</div>
								<div align="center">
									<button type="submit" class="btn btn-sm btn-primary" name="simpan"><i class="fa fa-save"></i> Save</button>
									<a href="<?php echo site_url('master/city/') ?>" class="btn btn-sm btn-danger" name="batal"><i class="fa fa-times"></i> Cancel</a>
								</div>
							</div>
						</div>
					</form>
