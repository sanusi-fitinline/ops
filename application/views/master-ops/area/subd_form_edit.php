...
<div class="container-fluid">
    ...
    <div class="card mb-3">
    	<div class="card-header">
        	...
        	Edit Data Subdistrict
        </div>
      	<div class="card-body">
      		<div class="row">
				<div class="col-md-12 offset-md-4">
					<h3>Edit Subdistrict</h3>
					<form action="<?php echo site_url('master/editsubdprocess/'.$row->SUBD_ID)?>" method="POST" enctype="multipart/form-data">
						<div class="row">
							<div class="col-md-3">
								<input class="form-control" type="hidden" name="SUBD_ID" value="<?php echo $row->SUBD_ID ?>" required>
								...
								<div class="form-group">
									...
									<select class="form-control selectpicker" name="CITY_ID" id="CITY_ID" data-live-search="true" required>
							    		<option value="<?php echo $row->CITY_ID ?>">
							    			<?php echo stripslashes($row->CITY_NAME) ?>
							    		</option>
							    		<div id="loading" style="margin-top: 15px;">
								         	<img src="<?php echo base_url('assets/images/loading.gif') ?>" width="18"> <small>Loading...</small>
								        </div>								    	
								...
								<div class="form-group">
									...
									<input class="form-control" type="text" name="SUBD_NAME" value="<?php echo stripslashes($row->SUBD_NAME) ?>" autocomplete="off" required>
								</div>
								<div align="center">
									<?php $this->load->model('access_m');?>
									<?php if((!$this->access_m->isEdit('Subdistrict', 1)->row()) && ($this->session->GRP_SESSION !=3)) : ?>
										<a href="<?php echo site_url('master/subdistrict/') ?>" class="btn btn-warning" name="batal"><i class="fa fa-arrow-left"></i> Back</a>
									<?php else: ?>
