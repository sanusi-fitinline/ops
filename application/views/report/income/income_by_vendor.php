...
<div class="container-fluid">
	...
	<ol class="breadcrumb">
		<li class="breadcrumb-item">
	  	...
	  	<li class="breadcrumb-item active">Income by Vendor</li>
	</ol>
    <!-- DataTables Example -->
    <div class="card mb-3">
    	<div class="card-header">
      	...
      	<div class="card-body">
			<div class="row">
				...
				<div class="col-md-3">			
					<div class="form-group">
						<select class="form-control form-control-sm selectpicker" data-live-search="true" title="-- Select Vendor --" name="VEND_ID" id="VENDOR_INCOME">
          		...
          		<table class="table table-bordered" width="100%" cellspacing="0">
            		<thead style="font-size: 14px;">
	                	<tr>
							...
							<th style="vertical-align: middle; text-align: center; width: 350px;">VENDOR</th>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#myChart').hide();
		$("#loading").hide();
		$("#GENERATE_REPORT_VENDOR").click(function(){
			if ($('#FROM').val() == null) {
		        var FROM_VALUE = null;
	    	} else {
	    	...
	    	$.ajax({
		        ...
		        success: function(response){
		        	...
		        	if ((FROM_VALUE != null && TO_VALUE != null)) {
		        		chart.data.labels= response.list_vend_name;
