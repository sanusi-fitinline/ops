		    	...
		    	<div class="card-header">
		      	...
		      	<div class="card-body">
		      		<div class="row">
						...
						<?php if((!$this->access_m->isViewAll('Sample to Order', 1)->row()) && ($this->session->GRP_SESSION !=3)):?>
						...
						<div class="col-md-3">			
							<div class="form-group" align="right">
								...
								<a class="btn btn-sm btn-default" style="border: 2px solid #dc3545;" href="<?php echo site_url('report/sample_order') ?>"><i class="fa fa-redo"></i> Reset</a>
							</div>
						</div>
					</div>
					<br>
