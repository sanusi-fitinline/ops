						                	...
						                	<?php foreach($model as $value): ?>
							                	<tr>
							                		<td align="center" style="width: 10px;">
							                			<a href="<?php echo site_url('prospect/del_model/'.$row->PRJ_ID.'/'.$detail->PRJD_ID.'/'.$value->PRJDM_ID) ?>" class="DELETE-MODEL" style="color: #dc3545; float: left;" onclick="return confirm('Delete Item?')" title="Delete"><i class="fa fa-trash"></i></a>
