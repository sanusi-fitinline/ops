...
<div class="container-fluid">
    ...
    <div class="card mb-3">
    	...
    	<div class="card-header">
      	...
      	<div class="card-body">
      		<div>
				<a <?php if((!$this->access_m->isAdd('Check Stock CS', 1)->row()) && ($this->session->GRP_SESSION !=3)){echo "hidden";}?> href="<?php echo site_url('cs/add_check') ?>" class="btn btn-success btn-sm"><i class="fa fa-user-plus"></i> Add</a>
			</div><br>
			<div class="row">
				<div class="col-md-3">			
				...
				<div class="col-md-2">			
					<div class="form-group">
						<input class="form-control datepicker" type="text" name="FROM" id="FROM" placeholder="From">
					</div>
				</div>
				<div class="col-md-2">			
					<div class="form-group">
						<input class="form-control datepicker" type="text" name="TO" id="TO" placeholder="To">
					</div>
				</div>
				<div class="col-md-2">			
					<div class="form-group">
						<select class="form-control selectpicker" title="-Select Status-" name="status" id="STATUS">
				    		<option value="1" <?php if($this->uri->segment(2) == "unchecked_stock"){echo "selected";} ?>>Unchecked</option>
				...
				<div class="col-md-3">			
					<div class="form-group" align="right">
						<button class="btn btn-sm btn-default" style="margin-top: 3px; border: 2px solid #17a2b8;" id="search-stock"><i class="fa fa-search"></i> Search</button>
						<a class="btn btn-sm btn-default" style="margin-top: 3px; border: 2px solid #dc3545;" href="<?php echo site_url('cs/check_stock') ?>"><i class="fa fa-redo"></i> Reset</a>
					</div>
				</div>
			</div>
        	<div class="table-responsive" id="check-stock1">
      		...
      		<div class="table-responsive" id="check-stock2">
          		<table class="table table-bordered" id="tableCsCheck2" width="100%" cellspacing="0">
            		<thead style="font-size: 14px;">
	                	<tr>
							<th style="vertical-align: middle; text-align: center; width: 100px;">STOCK STATUS</th>
							<th style="vertical-align: middle; text-align: center; width: 125px;">DATE</th>
