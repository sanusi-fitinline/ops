          		...
          		<table class="table table-bordered" id="table_payment_customer" width="100%" cellspacing="0">
            		<thead style="font-size: 14px">
	                	<tr>
	                    	...
	                    	<th style="vertical-align: middle; text-align: center; width: 140px;">INVOICE DATE</th>
	                    	<th style="vertical-align: middle; text-align: center; width: 100px;">AMOUNT</th>
							<th style="vertical-align: middle; text-align: center; width: 120px;">PAYMENT DATE</th>
							<th style="vertical-align: middle; text-align: center; width: 70px;">TERMIN</th>
