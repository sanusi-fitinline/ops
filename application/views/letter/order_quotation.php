<?php 
	...
	$tahun 		  = date('Y');
	$format_nomor = $kode."/OPS/QUO/".$romawi."/".$tahun;
	//
?>
<!-- Page Content -->
								...
								<div class="row">
									<div class="col-md-3">
										<div class="form-group">
											<input type="hidden" name="ORDL_TYPE" value="1">
									...
									<div class="col-md-9">
										<div class="form-group">
											...
											} ?>3. Transaksi tanpa pajak. Pembayaran dapat ditransfer melalui Bank BCA: 8020169363 atau Bank Mandiri: 1240004177276 atas nama Istofani Api Diany.</textarea>
										</div>
										<div align="center">
