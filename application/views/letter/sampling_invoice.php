									...
									<div class="col-md-9">
										<div class="form-group">
											...
											<textarea class="form-control" cols="100%" rows="7" name="ORDL_NOTES">1. Pengiriman dari <?php 
												echo $sampling->ORIGIN_CITY_NAME.", menggunakan ".$sampling->COURIER_NAME." ".$sampling->LSAM_SERVICE_TYPE.".&#13;&#10;";?>2. Transaksi tanpa pajak. Pembayaran dapat ditransfer melalui Bank BCA: 8020169363 atau Bank Mandiri: 1240004177276 atas nama Istofani Api Diany.</textarea>
										</div>
										<div align="center">
