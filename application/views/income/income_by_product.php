...
<div class="container-fluid">
	...
	<ol class="breadcrumb">
		<li class="breadcrumb-item">
	  	...
	  	<li class="breadcrumb-item active">Income by Product</li>
	</ol>
    <!-- DataTables Example -->
    <div class="card mb-3">
          		...
          		<table class="table table-bordered" width="100%" cellspacing="0">
            		<thead style="font-size: 14px;">
	                	<tr>
							...
							<th style="vertical-align: middle; text-align: center; width: 500px;">PRODUCT</th>
							<th style="vertical-align: middle; text-align: center; width: 350px;">OPTION</th>
	                    	<th style="vertical-align: middle; text-align: center; width: 70px;">QTY</th>
	                    	<th style="vertical-align: middle; text-align: center; width: 150px;">PRICE</th>
	                    	<th style="vertical-align: middle; text-align: center; width: 200px;">SUBTOTAL</th>
	                  	</tr>
	                </thead>
	                <tbody style="font-size: 14px;" id="loading">
	                	<tr>
	                		<td align="center" colspan="7"><img width="100px" src="<?php echo base_url('assets/images/loading.gif') ?>"></td>
	                	</tr>
					</tbody>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#myChart').hide();
		$("#loading").hide();
		$("#GENERATE_REPORT_PRODUCT").click(function(){
			if ($('#FROM').val() == null) {
		        var FROM_VALUE = null;
	    	} else {
	    	...
	    	$.ajax({
		        type: "POST", 
		        url: "<?php echo site_url('report/income_by_productjson'); ?>", 
		        data: {
		        	FROM 	: FROM_VALUE,
		        	TO 		: TO_VALUE,
		        	PRO_ID	: $("#PRODUCT_INCOME").val(),
		        	}, 
		        dataType: "json",
		        ...
		        success: function(response){
		        	...
		        	if ((FROM_VALUE != null && TO_VALUE != null)) {
		        		chart.data.labels= response.list_pro_name;
		        ...
		        error: function (xhr, ajaxOptions, thrownError) {
		          	...
		          	$("#BODY_REPORT").show();
		   			$("#FOOTER_REPORT").hide();
		          	$("#loading").hide();
		          	$("#BODY_REPORT").html("<tr><td align='center' colspan='7'>No data available in table</td></tr>");
		        }
		    });
		});
	});
