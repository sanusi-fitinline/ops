    	...
    	<div class="card-header">
      	...
      	<div class="card-body">
			<div class="row">
				...
				<div class="col-md-3">			
					<div class="form-group">
						<select class="form-control selectpicker" title="--- Select CS ---" name="USER_ID" id="USER_INCOME">
				...
				<div class="col-md-3">			
					<div class="form-group" align="right">
						<button class="btn btn-sm btn-info" style="margin-top: 3px;" id="GENERATE_REPORT_CS"><i class="fa fa-print"></i> Generate Report</button>
						<a class="btn btn-sm btn-danger" style="margin-top: 3px;" href="<?php echo site_url('report/income_by_cs') ?>"><i class="fa fa-redo"></i> Reset</a>
					</div>
				</div>
			</div>
