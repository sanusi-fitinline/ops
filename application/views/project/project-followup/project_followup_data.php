...
<div class="container-fluid">
	...
	<ol class="breadcrumb">
		<li class="breadcrumb-item">
	  	...
	  	<li class="breadcrumb-item active">Project Follow Up</li>
	</ol>
    <!-- DataTables Example -->
    <div class="card mb-3">
    	<div class="card-header">
      	...
      	<div class="card-body">
			<div class="row">
				<div class="col-md-9">			
					<div class="form-group" align="right">
						...
						<button class="form-control-sm btn btn-sm btn-default" style="border: 2px solid #17a2b8;" id="FILTER_PROJECT_FOLLOW_UP"><i class="fas fa-filter"></i> Filter</button>
					</div>
				</div>
				<div class="col-md-3">			
        	...
        	<div class="table-responsive">
          		<table class="table table-bordered" id="myTableProjectFollowUp" width="100%" cellspacing="0">
            		<thead style="font-size: 14px">
	                	<tr>
	                    	...
	                    	<th style="vertical-align: middle; text-align: center; width: 100px;">PROJECT DATE</th>
