		...
		<div class="col-md-12">
		    <div class="card mb-3">
		    	<div class="card-header">
		      	...
		      	<div class="card-body">
					<!-- Offer -->
					<form action="<?php echo site_url('project_followup/add_offer_process')?>" method="POST" enctype="multipart/form-data">
						<h4>Add Offer</h4>
						<div class="row">
							<div class="col-md-4">
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<div class="input-group">
											...
											<input class="form-control uang" type="text" name="PRJPRD_PRICE[]" autocomplete="off" required>
									    </div>
									</div>
								</div>
							<?php endforeach ?>
