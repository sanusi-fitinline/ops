		...
		<div class="col-md-12">
		    <div class="card mb-3">
		    	<div class="card-header">
		      	...
		      	<div class="card-body">
					<!-- Offer -->
					<form action="<?php echo site_url('project_followup/edit_offer_process/'.$detail->PRJD_ID)?>" method="POST" enctype="multipart/form-data">
						<h4>Edit Offer</h4>
						<div class="row">
							<div class="col-md-4">
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<div class="input-group">
											...
											<input class="form-control uang" type="text" name="PRJPRD_PRICE[]" value="<?php echo $field->PRJPRD_PRICE ?>" autocomplete="off" required>
									    </div>
									</div>
								</div>
							<?php endforeach ?>
							<div class="col-md-12" align="center">
	                    		...
	                    		<a href="<?php echo site_url('project_followup/detail/'.$detail->PRJ_ID.'/'.$detail->PRJD_ID) ?>" class="btn btn-danger"><i class="fa fa-times"></i>&nbsp;&nbsp;Cancel</a>
							</div>
						</div>
					</form>
		      	</div>
